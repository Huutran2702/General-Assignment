...
public class ManipulatingResultSetView {
    private static final CandidateView candidateView = new CandidateView();

    public static void insertAndUpdateByResultSet() {
        System.out.println("✿ ✿ ✿ ✿ ✿ ✿ ✿ ✿ ✿ CHỌN ✿ ✿ ✿ ✿ ✿ ✿ ✿ ✿ ✿");
        System.out.println("✿                                              ✿");
        System.out.println("✿   1. Thêm ứng viên mới                       ✿");
        System.out.println("✿   2. Cập nhật ứng viên                       ✿");
    ...
    private static void updateCandidate() {
        try {
                ...
                do {
                    ...
                    switch (candidateType) {
                        case 0:
                            ...
                            candidateView.candidateDAO.updateCandidateByResultSet(experience);
                        ...
                        case 1:
                            ...
                            candidateView.candidateDAO.updateCandidateByResultSet(fresher);
                            checkCandidateType = false;
                            break;
                        case 2:
                            candidateView.scanner.nextLine();
                            ...
                            candidateView.candidateDAO.updateCandidateByResultSet(intern);
                            checkCandidateType = false;
                            break;
                        default:
            ...
            boolean check = true;
            do {
                System.out.println("Nhấn 'y' để cập nhật tiếp ứng viên \t|\t 'q' để quay lại \t|\t 't' để thoát");
                System.out.print(" ⭆ ");
                ...
                do {
                    ...
                    switch (candidateType) {
                        case 0:
                            ...
                            String proSkill = candidateView.scanner.nextLine();
                            Experience experience = new Experience(candidateID, fullName, birthDaySQL, phone, email, expInYear, proSkill);
                            candidateView.candidateDAO.insertCandidateByResultSet(experience);
                            checkCandidateType = false;
                            break;
                        case 1:
                            candidateView.scanner.nextLine();
                            ...
                            String education = candidateView.scanner.nextLine();
                            Fresher fresher = new Fresher(candidateID, fullName, birthDaySQL, phone, email, graduationDateSQL, graduationRank, education);
                            candidateView.candidateDAO.insertCandidateByResultSet(fresher);
                            checkCandidateType = false;
                            break;
                        case 2:
                            candidateView.scanner.nextLine();
                            ...
                            String universityName = candidateView.scanner.nextLine();
                            Intern intern = new Intern(candidateID, fullName, birthDaySQL, phone, email, majors, semester, universityName);
                            candidateView.candidateDAO.insertCandidateByResultSet(intern);
                            checkCandidateType = false;
                            break;
                        default:
                            System.out.println("Nhập kiểu ứng viên chưa phù hợp - vui lòng nhập lại: ");
